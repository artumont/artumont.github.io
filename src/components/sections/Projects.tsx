...
const projects = [
    ...
    },
    {
        ...
        why: "Built for HackMTY 2026 Altur Challenge. WavLM embeddings + 3-layer MLP classifier with isotonic calibration, deployed via FastAPI + ONNX Runtime.",
        stack: ["Python", "FastAPI", "WavLM", "ONNX", "Docker", "Next.js"],
        github: "https://github.com/artumont/altur-vconstruct",
        link: null,
        blog: null,
    },
    {
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="flex-grow">
                                <h3 className="text-xl font-jetbrains mb-3">
                                    {project.name}
                                </h3>
                                <p className="text-accent mb-3 font-inter text-sm">
                                    {project.description}
                                </p>
                                <p className="text-accent/70 mb-4 font-inter text-xs italic">
                                    {project.why}
                                </p>
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.stack.map((tech) => (
                                        <span
                                            key={tech}
                                            className="bg-terciary text-xs px-2 py-1 rounded-lg font-inter"
                                        >
                                            {tech}
                                        </span>
                                    ))}
